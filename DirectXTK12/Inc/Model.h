...
namespace DirectX
{
    ...
    public:
        ...
        // Render the mesh with an effect
        ...
        // Render the mesh with a callback for each mesh part
        ...
        // Render the mesh with a range of effects that mesh parts will index into.
    ...
    public:
        ...
        // NOTE
        //
        // The Model::Render functions use variadic templates and perfect-forwarding in order to support future overloads to the ModelMesh::Render
        // family of functions. This means that a new ModelMesh::Render overload can be added, removed or altered, but the Model::Render* routines
        // will still remain compatible. The correct ModelMesh::Render overload will be selected by the compiler depending on the arguments you
        // provide to Model::Render*.
        //

        // Render all the opaque meshes in the model
        ...
        // Render all the alpha meshes in the model
